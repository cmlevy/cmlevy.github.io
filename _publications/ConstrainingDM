...
paperurl: 'cmlevy.github.io/files/ConstrainingDM.pdf'
citation: 'C. Ilie, C. Levy, J. Pilawa, and S. Zhang. <i>Constraining Dark Matter properties with the first generation of stars</i>.
